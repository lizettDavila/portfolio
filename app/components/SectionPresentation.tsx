    ...
    return (
        <section id="home" className='pt-8'>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mt-20">
                ...
                <div className="relative w-full max-w-sm mx-auto md:max-w-none flex justify-center px-2">
                    <div className='absolute z-10 w-96 h-96 animate-pulse animate-infinite shadow-2xl shadow-sky-500/65  rounded-full' />
                    <div className="w-96 z-20 h-96 bg-center bg-no-repeat aspect-square bg-cover rounded-full" data-alt="professional headshot of Lizett Enríquez" style={{ backgroundImage: 'url("/myPhoto.jpg")' }}></div>
                </div>
            </div>
        </section>
