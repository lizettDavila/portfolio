                    ...
                    <div  className="grid lg:grid-cols-2">
                        ...
                        <div className="flex flex-col justify-center p-8">
                            ...
                            <div className="flex items-center gap-4 mt-auto">
                                <Link className="shadow-sm shadow-teal-500/40 flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-teal-500 text-white text-sm font-medium leading-normal hover:opacity-90 transition-opacity" href={liveDemoLink} target="_blank" rel="noopener noreferrer    ">
                                    <span className="truncate">Live Demo</span>
                                </Link>
                                <Link className="shadow-sm shadow-gray-500/40 flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 border border-gray-300 dark:border-gray-600 text-sm font-medium leading-normal hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" href={codeLink} target="_blank" rel="noopener noreferrer">
