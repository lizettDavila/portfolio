...
const Skills = () => {
    ...
    return (
        <section id="skills" ref={sectionRef} className="pt-20 mx-4" >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 text-center">
                    {skills.map(skill => (
                        <div className=" flex flex-col items-center gap-2" key={skill}>
                            <div className="hover:scale-150 hover:duration-400 hover:ease-in shadow-sm shadow-gray-900/50 w-16 h-16 rounded-full flex items-center justify-center bg-teal-500/20">
